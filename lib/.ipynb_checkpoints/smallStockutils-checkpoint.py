...
def loadData(args):
    ...
    path = '/root/autodl-tmp/Stockformer/Stockformer_run/Stockformer_code/data/CN_Stock_83/stock(83,158)'
    ...
    # trend_train, seasonal_train = vmd_decomposition(train)
    ## val
    trend_val, seasonal_val = stl_decomposition(val)
    # trend_val, seasonal_val = vmd_decomposition(val)
    ## test
    trend_test, seasonal_test = stl_decomposition(test)
    # trend_test, seasonal_test = vmd_decomposition(test)
